...
var CI = (function(){
    ...
    function showRectangle(bounds){
        ...
        if(myPerimeter === null){
            myPerimeter = new google.maps.Circle({
                map: CI.gmaps,
                editable: true,
                center: CI.gmaps.myLocation,
                radius: myDistance
            });

            myPerimeter.setMap(CI.gmaps);

            // Add an event listener on the rectangle.
            myPerimeter.addListener('radius_changed', showNewRect);
        }
    }
    ...
    function reserveCar(car){
        // $.ajax({
        //     url: "https://formspree.io/5149428138@vmobile.ca",
        //     method: "POST",
        //     data: {message: JSON.stringify(car)},
        //     dataType: "json"
        // });
        emailjs.send(
            "gmail",
            "automobile_reservation",
            {"to_email":"5149428138@vmobile.ca",
                "to_name":"Fred",
                "message_html":"This is your reservation"
            })
    }
